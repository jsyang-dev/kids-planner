...
public class HolidayStep extends AcceptanceStep {
    ...
    public static ExtractableResponse<Response> 공휴일_생성(HolidayRequest holidayRequest) {
        return 공휴일_생성(givenSpec(), holidayRequest);
    }

    public static ExtractableResponse<Response> 공휴일_생성(RequestSpecification specification, HolidayRequest holidayRequest) {
